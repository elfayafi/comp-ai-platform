...
description: "Connect Azure to Compiel for cloud security testing"
---

# Azure Cloud Test

The Azure Cloud Test enables you to connect your Microsoft Azure cloud environment to Compiel for comprehensive security testing, compliance monitoring, and risk assessment using Microsoft Defender for Cloud
...
3. **Register an Application in Azure AD**
   ...
   - Name the app (e.g., `CompielIntegrationApp`)
...
Compiel requires read-only access to your Azure environment. The integration uses Azure's built-in Reader role or custom roles with specific permissions that follow the principle of least privilege.
