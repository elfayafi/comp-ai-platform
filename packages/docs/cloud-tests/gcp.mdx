...
description: "Connect Google Cloud Platform to Compiel for cloud security testing"
---

# Google Cloud Platform Cloud Test

The Google Cloud Platform (GCP) Cloud Test allows you to connect your GCP projects to Compiel for automated compliance monitoring, and risk assessment.
...
2. Admin access to your Compiel workspace
...
1. Navigate to **Cloud Tests** in your Compiel dashboard
...
3. Link Service Account
   ...
   - Click **“Create Service Account”** and give it a name like `compiel-integration`
...
4. Add Credentials to GCP Cloud Test in Compiel app
   1. Copy & Paste the Organization Id (Not the project Id) from Google Cloud into the **Organization ID** field in the Compiel connection form
   1. Open the downloaded JSON file, and copy its entire contents
   2. Paste it into the **Service Account Key** field in the Compiel connection form
...
Compiel requires read-only access to your GCP environment. The Cloud Test uses a service account with specific IAM roles that follow the principle of least privilege.
...
1. Check our [Knowledge Base](https://help.trycompiel.com/gcp-integration)
2. Contact support at [support@trycompiel.com](mailto:support@trycompiel.com)
