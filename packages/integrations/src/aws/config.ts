...
const config: {
  ...
  guide_url: 'https://trycompiel.com/docs/cloud-tests/aws',
  description:
    'Compiel can automatically collect evidence from your AWS account to show your cloud infrastructure is compliant with different compliance frameworks.',
  images: [],
  settings: [
    {
      id: 'region',
